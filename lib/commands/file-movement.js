 ...
 * The path may contains environment variables that can be expanded on the server side.
 * By security reason only variables listed below would be expanded: `APPDATA`,
 ...
 * remote path is not absolute path.
 */
